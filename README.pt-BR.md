...
<p align="center">
  <a href="https://stringke.github.io/claudex/pt-BR/">Documentação</a>
</p>
...
- Windows: baixe o binário pré-compilado em [Releases](https://github.com/josephismikhail/claudex/releases)
...
| Assinatura ChatGPT/Codex | OpenAIResponses | Anthropic <-> Responses | OAuth (PKCE/Device) | `gpt-5.3-codex` |
