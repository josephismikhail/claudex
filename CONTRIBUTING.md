...
```bash
git clone https://github.com/josephismikhail/claudex.git
cd claudex
cargo build
cargo test
```
...
We especially welcome contributions adding new AI providers! See the [Provider Request](https://github.com/josephismikhail/claudex/issues/new?template=provider_request.yml) template.
...
To report a security vulnerability, please use [GitHub Private Vulnerability Reporting](https://github.com/josephismikhail/claudex/security/advisories/new). See [SECURITY.md](SECURITY.md) for details.
...
我们特别欢迎添加新 AI 提供商的贡献！请使用 [Provider Request](https://github.com/josephismikhail/claudex/issues/new?template=provider_request.yml) 模板。
...
报告安全漏洞请使用 [GitHub 私密漏洞报告](https://github.com/josephismikhail/claudex/security/advisories/new)。详见 [SECURITY.md](SECURITY.md)。
