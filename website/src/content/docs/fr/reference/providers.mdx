...
| Claude (Abo) | DirectAnthropic | OAuth | Oui | Oui | Oui | Local gateway + Claude Code credentials |
...
- **Note** Uses the local gateway, which reuses and refreshes Claude Code OAuth credentials.
