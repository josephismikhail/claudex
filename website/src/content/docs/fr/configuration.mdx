...
Consultez [`config.example.toml`](https://github.com/josephismikhail/claudex/blob/main/config.example.toml) pour un fichier de configuration complet avec tous les fournisseurs et options.
