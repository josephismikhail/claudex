...
| Claude (Abo) | DirectAnthropic | OAuth | Ja | Ja | Ja | Local gateway + Claude Code credentials |
...
- **Hinweis**: Uses the local gateway, which reuses and refreshes Claude Code OAuth credentials.
