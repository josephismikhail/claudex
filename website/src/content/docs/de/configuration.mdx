...
Siehe [`config.example.toml`](https://github.com/josephismikhail/claudex/blob/main/config.example.toml) fuer eine vollstaendige Konfigurationsdatei mit allen Anbietern und Optionen.
