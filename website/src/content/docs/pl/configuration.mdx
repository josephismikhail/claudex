...
Zobacz [`config.example.toml`](https://github.com/josephismikhail/claudex/blob/main/config.example.toml), aby uzyskac kompletny plik konfiguracyjny ze wszystkimi dostawcami i opcjami.
