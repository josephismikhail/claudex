...
См. [`config.example.toml`](https://github.com/josephismikhail/claudex/blob/main/config.example.toml) для полного конфигурационного файла со всеми провайдерами и опциями.
