...
Consulte [`config.example.toml`](https://github.com/josephismikhail/claudex/blob/main/config.example.toml) para um arquivo de configuracao completo com todos os provedores e opcoes.
