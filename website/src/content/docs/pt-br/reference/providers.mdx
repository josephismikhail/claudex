...
| Claude (Assinatura) | DirectAnthropic | OAuth | Sim | Sim | Sim | Local gateway + Claude Code credentials |
...
- **Nota**: Uses the local gateway, which reuses and refreshes Claude Code OAuth credentials.
