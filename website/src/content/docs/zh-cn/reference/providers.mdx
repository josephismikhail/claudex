...
| Claude（订阅） | DirectAnthropic | OAuth | 支持 | 支持 | 支持 | Local gateway + Claude Code credentials |
...
- **备注**: Uses the local gateway, which reuses and refreshes Claude Code OAuth credentials.
